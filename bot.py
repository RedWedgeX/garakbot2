...
bot = commands.Bot(command_prefix="!", description='Garak\'s Craftier\'s Bot.', intents=intents)
...
async def on_ready():
    ...
    await bot.change_presence(
        activity=discord.Streaming(name='Dom Jot', url='https://www.facebook.com/groups/garakscraftiers/'))
